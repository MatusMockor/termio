...
final class TenantFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'reservation_lead_time_hours' => (int) config('reservation.defaults.lead_time_hours'),
            'reservation_max_days_in_advance' => (int) config('reservation.defaults.max_days_in_advance'),
            'reservation_slot_interval_minutes' => (int) config('reservation.defaults.slot_interval_minutes'),
            'settings' => [],
            'status' => 'active',
            'stripe_id' => null,
            'pm_type' => null,
