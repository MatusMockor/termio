    ...
    public function run(): void
    {
        $plans = [
            ...
            [
                ...
                'monthly_price' => (float) config('plans.pricing.easy.monthly', 6.00),
                'yearly_price' => (float) config('plans.pricing.easy.yearly', 54.00),
                ...
                'features' => [
                    ...
                    'service_taxonomy_priority' => true,
            ...
            [
                ...
                'monthly_price' => (float) config('plans.pricing.smart.monthly', 15.00),
                'yearly_price' => (float) config('plans.pricing.smart.yearly', 135.00),
            ...
            [
                ...
                'monthly_price' => (float) config('plans.pricing.standard.monthly', 30.00),
                'yearly_price' => (float) config('plans.pricing.standard.yearly', 270.00),
            ...
            [
                ...
                'monthly_price' => (float) config('plans.pricing.premium.monthly', 50.00),
                'yearly_price' => (float) config('plans.pricing.premium.yearly', 450.00),
